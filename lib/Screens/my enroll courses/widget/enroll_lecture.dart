...
class EnrollLecture extends StatefulWidget {
  EnrollLecture({
    super.key,
  ...
  @override
  State<EnrollLecture> createState() => _EnrollLectureState();
}

class _EnrollLectureState extends State<EnrollLecture> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 25),
              Text(
                  "Lecture Time:    ${widget.courseInfo.lectureDuration} Hours",
                  style: GoogleFonts.roboto(
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
                      color: const Color(0xff3F3F3F))),
